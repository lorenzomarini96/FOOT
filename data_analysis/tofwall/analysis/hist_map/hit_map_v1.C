...
void rec::Loop()
{
   ...
   // ProjectionX
   TCanvas *c2 = new TCanvas("c2", "hitmap_x",600,600);
   c2->SetTickx();
   c2->SetTicky();
   c2->SetLeftMargin(0.15);
   TH1D *hist_bar_x = hist->ProjectionX("hist_bar_x",0,20);
   hist_bar_x->SetFillColor(kCyan-9);
   hist_bar_x->Draw();

   // ProjectionY
   TCanvas *c3 = new TCanvas("c3", "hitmap_y",600,600);
   c3->SetTickx();
   c3->SetTicky();
   c3->SetLeftMargin(0.15);
   TH1D *hist_bar_y = hist->ProjectionY("hist_bar_y",20,40);
   hist_bar_y->SetFillColor(kCyan-9);
   hist_bar_y->Draw();
}
